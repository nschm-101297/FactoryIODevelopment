...
declare class TcHmiEventGrid extends TcHmi.Controls.System.TcHmiControl {
    ...
    protected __noPayloadsFilter: import("Beckhoff.TwinCAT.HMI.Framework/index.esm.js").FilterInstance<any>;
     ...
     */
    protected __getCanConfirmCommand(): readonly [TcHmi.Server.ICommand<"ConfirmAlarm", import("Beckhoff.TwinCAT.HMI.Framework/dist/API/ServerTypes.js").ACCESS>, (cmd: TcHmi.Server.ICommand<"ConfirmAlarm", import("Beckhoff.TwinCAT.HMI.Framework/dist/API/ServerTypes.js").ACCESS>, data: TcHmi.Server.IResultObject) => void];
    /**
