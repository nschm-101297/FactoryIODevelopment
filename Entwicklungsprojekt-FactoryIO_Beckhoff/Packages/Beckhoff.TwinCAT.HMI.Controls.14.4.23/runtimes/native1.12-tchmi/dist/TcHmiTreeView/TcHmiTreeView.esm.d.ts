...
import type { Editor } from '../Helpers/TcHmiJsonEditors/BaseEditors/Editor.js';
import type { ObjectEditor } from '../Helpers/TcHmiJsonEditors/BaseEditors/ObjectEditor.js';
...
declare class TcHmiTreeView extends TcHmiControl.Control {
    ...
    protected __editorInfo: Editor.EditorInfo | null | undefined;
     ...
     */
    protected __getEditorInfoByOriginalIndexAndPropertyName(editorInfo: Editor.EditorInfo | undefined, index: number[], propertyName: string): Editor.EditorInfo | undefined;
    /**
     * Get the Editor Info of a specific object and property by the hierarchical index and property name
     * @param editorInfo base editor info
     * @param index The hierarchical index
     * @param propertyName The property name
     */
    protected __getEditorInfoByOriginalIndex(editorInfo: Editor.EditorInfo | undefined, index: number[]): ObjectEditor.Info | undefined;
    /**
     * Get the editorInfo of an optionalEditor if the parameter is an optionalEditor
     * @param editorInfo
     */
    protected __removeOptionalEditorLayer(editorInfo: Editor.EditorInfo | undefined): Editor.EditorInfo | undefined;
    /**
     *
     * @param editorInfo
     */
    protected __getColumnControlInfoByEditorInfo(editorInfo: Editor.EditorInfo | undefined): {
     ...
     */
    getFilterStrategy(): import("Beckhoff.TwinCAT.HMI.Framework/index.esm.js").FilterInstance.Strategy | undefined;
    /**
