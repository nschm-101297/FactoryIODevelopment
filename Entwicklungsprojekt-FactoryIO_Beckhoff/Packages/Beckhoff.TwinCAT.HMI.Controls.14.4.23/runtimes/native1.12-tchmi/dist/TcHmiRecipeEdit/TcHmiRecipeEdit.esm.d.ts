...
declare class TcHmiRecipeEdit extends TcHmiControl.Control {
    ...
    protected __symbolAccess: {
        '{0}.Config': import("Beckhoff.TwinCAT.HMI.Framework/dist/API/ServerTypes.js").ACCESS;
        Rename: import("Beckhoff.TwinCAT.HMI.Framework/dist/API/ServerTypes.js").ACCESS;
        '{0}.ActivateRecipe': import("Beckhoff.TwinCAT.HMI.Framework/dist/API/ServerTypes.js").ACCESS;
        '{0}.ReadFromTarget': import("Beckhoff.TwinCAT.HMI.Framework/dist/API/ServerTypes.js").ACCESS;
        '{0}.UpdateRecipe': import("Beckhoff.TwinCAT.HMI.Framework/dist/API/ServerTypes.js").ACCESS;
        '{0}.GetActiveRecipes': import("Beckhoff.TwinCAT.HMI.Framework/dist/API/ServerTypes.js").ACCESS;
    };
    protected __buttons: {
