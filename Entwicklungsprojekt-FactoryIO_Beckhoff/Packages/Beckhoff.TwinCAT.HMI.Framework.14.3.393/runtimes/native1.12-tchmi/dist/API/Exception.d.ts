...
export declare class Exception extends Error {
     ...
     * @param optionalParameters Optional parameters that are appended to the logged message.
     */
    log(control: TcHmi.Controls.System.baseTcHmiControl, origin: string, additionalInfo: Log.Controls.AdditionalInfo, message?: string, ...optionalParameters: any[]): void;
}
...
type tLogInfo<T extends string> = Exception.LogInfo<T>;
type tControlInfo = Exception.ControlInfo;
type tFrameworkInfo = Exception.FrameworkInfo;
type tFunctionInfo = Exception.FunctionInfo;
declare global {
    namespace TcHmi {
