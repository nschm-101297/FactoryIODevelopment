...
export declare class SymbolExpression {
     ...
     * @preserve (Part of the public API)
     */
    resolve(callback: (data: Symbol.IReadResultObject<SymbolExpression>) => void): TcHmi.DestroyFunction;
     ...
     * @preserve (Part of the public API)
     */
    watch(callback: (data: Symbol.IReadResultObject<SymbolExpression>) => void): TcHmi.DestroyFunction;
}
export declare namespace SymbolExpression {
    /**
...
type tIParseData = SymbolExpression.IParseData;
type tIOptions = SymbolExpression.IOptions;
declare global {
    namespace TcHmi {
