...
export declare class ObjectResolver<T extends object | null> {
     ...
     * until the controls parent partial (View, Content, UserControl) is initialized to guarantee that symbols of type Control which exist in this scope are available.
     */
    constructor(obj: TcHmi.AllowSymbolExpressionsAsValues<T>, options?: ObjectResolver.IOptions | null);
    /**
     * Resolves all symbol expression refs in the current object.
     * @param callback Callback will be called after success or failure
     * @preserve (Part of the public API)
     */
    resolve(callback?: (this: void, data: ObjectResolver.IResultObject<T>) => void): TcHmi.DestroyFunction;
    /**
     ...
     * @preserve (Part of the public API)
     */
    watch(callback?: (this: void, data: ObjectResolver.IWatchResultObject<T>) => void): TcHmi.DestroyFunction;
    /**
...
type tIWatchResultObject<T extends object | null> = ObjectResolver.IWatchResultObject<T>;
type tIResultObject<T extends object | null> = ObjectResolver.IResultObject<T>;
type tIOptions = ObjectResolver.IOptions;
declare global {
    namespace TcHmi {
