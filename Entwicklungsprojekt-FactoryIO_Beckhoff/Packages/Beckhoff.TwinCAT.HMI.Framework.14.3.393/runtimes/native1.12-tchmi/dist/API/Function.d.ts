...
export declare class Function<R = any> extends TcHmi.Destroyable {
     ...
     * @preserve (Part of the public API)
     */
    executeEx(requiredArgs: any[] | undefined, callback: (this: Function<R>, data: Function.IExecuteResultObject<R>) => void): TcHmi.DestroyFunction;
    /**
...
type tIExecuteResultObject<R = any> = Function.IExecuteResultObject<R>;
declare global {
    namespace TcHmi {
