import{createTask}from"../System/Callback.js";import{Symbol as SystemSymbol}from"../System/Symbol.js";import{SymbolExpression}from"./SymbolExpression.js";import{ObjectResolver as ApiObjectResolver}from"./ObjectResolver.js";import{Log}from"./Log.js";import*as Callback from"./Callback.js";
/**
...
/**
     ...
     * @param callback Callback will be called after success (with the schema) or failure
     * @preserve (Part of the public API)
     */resolveSchema(callback){const callstackLinker=createTask("Symbol.resolveSchema>"+this.getExpression());this.__symbol.resolveSchema(data=>{callstackLinker.run(()=>{data.error===TcHmi.Errors.NONE?Callback.callSafeEx(callback,this,{error:TcHmi.Errors.NONE,schema:data.schema,expressionResolved:data.expressionResolved,expression:data.expression}):Callback.callSafeEx(callback,this,{error:data.error,details:data.details,expressionResolved:data.expressionResolved,expression:data.expression})})})}
/**
...
/**
     ...
     * @param callback Callback will be called after success or failure
     * @preserve (Part of the public API)
     */exists(callback){this.__symbol.exists(data=>{data.error===TcHmi.Errors.NONE?Callback.callSafeEx(callback,this,{error:TcHmi.Errors.NONE,result:data.result,expressionResolved:data.expressionResolved,expression:data.expression}):Callback.callSafeEx(callback,this,{error:data.error,details:data.details,expressionResolved:data.expressionResolved,expression:data.expression})})}
/**
...
/**
     ...
     * @preserve (Part of the public API)
     */
function(expressionOrExpressionObject,callback){let s=new Symbol(expressionOrExpressionObject);s.resolveSchema(function(data){data.error===TcHmi.Errors.NONE?Callback.callSafeEx(callback,null,{error:TcHmi.Errors.NONE,schema:data.schema,expressionResolved:data.expressionResolved,expression:data.expression}):Callback.callSafeEx(callback,null,{error:data.error,details:data.details,expressionResolved:data.expressionResolved,expression:data.expression}),s.destroy()})},Symbol.resolveAttributes=
/**
     * Resolves a dictionary of PLC (?) attributes from the underlying schema.
     * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
     * @param callback Callback will be called after success or failure
...
/**
     ...
     * @preserve (Part of the public API)
     */
function(expressionOrExpressionObject,callback){let s=new Symbol(expressionOrExpressionObject);s.exists(data=>{data.error===TcHmi.Errors.NONE?Callback.callSafeEx(callback,null,{error:TcHmi.Errors.NONE,result:data.result,expressionResolved:data.expressionResolved,expression:data.expression}):Callback.callSafeEx(callback,null,{error:data.error,details:data.details,expressionResolved:data.expressionResolved,expression:data.expression}),s.destroy()})},Symbol.isSymbolExpression=
/**
...
/**
     ...
     * @preserve (Part of the public API)
     */
function(expression){const exprMatch=expression.match(SymbolExpression.RegExpExpressionEscaped);return null!=exprMatch&&0===exprMatch.index?expression.replace("$",""):expression},Symbol.isIServerReadResultObject=isIServerReadResultObject}(Symbol||(Symbol={}));TcHmi.Symbol=Symbol;