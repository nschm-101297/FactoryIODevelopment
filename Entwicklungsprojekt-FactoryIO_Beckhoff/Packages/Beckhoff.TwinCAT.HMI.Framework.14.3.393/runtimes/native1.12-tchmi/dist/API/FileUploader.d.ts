...
export declare class FileUploader {
    ...
    protected readonly __options: TcHmi.SelectableRequired<FileUploader.Options, 'symbol'>;
    /**
...
type tFileStatus = FileUploader.FileStatus;
type tChunkType = FileUploader.ChunkType;
type tOptions = FileUploader.Options;
type tQueuedFile = FileUploader.QueuedFile;
type tProgressCallback = FileUploader.ProgressCallback;
type tProgressResult = FileUploader.ProgressResult;
type tProgressResultSuccess = FileUploader.ProgressResultSuccess;
type tProgressResultFail = FileUploader.ProgressResultFail;
type tChunk = FileUploader.Chunk;
type tUploadWriteValue = FileUploader.UploadWriteValue;
type tFileDialogOptions = FileUploader.FileDialogOptions;
declare global {
    namespace TcHmi {
