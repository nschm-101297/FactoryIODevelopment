...
export declare class Symbol<ST = any> extends TcHmi.Destroyable {
     ...
     * @preserve (Part of the public API)
     */
    readEx<T = ST>(callback?: (this: this, data: Symbol.IReadResultObject<T> | Symbol.IServerReadResultObject<T>) => void): TcHmi.DestroyFunction;
    /**
     * Reads the value of the current symbol and raises a callback with a copy of the result.
     * Returns a destroy function to terminate reading of asynchronous values.
     ...
     * @preserve (Part of the public API)
     */
    readEx2<T = ST>(options: Symbol.IOptions | null, callback?: (this: this, data: Symbol.IReadResultObject<T> | Symbol.IServerReadResultObject<T>) => void): TcHmi.DestroyFunction;
    /**
     ...
     * @preserve (Part of the public API)
     */
    write<W = ST, R = W>(value: W, callback?: (this: this, data: Symbol.IWriteResultObject<R> | Symbol.IServerWriteResultObject<W, R>) => void): TcHmi.DestroyFunction;
    /**
     * Writes the value of the current symbol.
     * Returns a destroy function to terminate writing of asynchronous values.
     ...
     * @preserve (Part of the public API)
     */
    writeEx<W = ST, R = W>(value: W, options: Symbol.IOptions | null, callback?: (this: this, data: Symbol.IWriteResultObject<R> | Symbol.IServerWriteResultObject<W, R>) => void): TcHmi.DestroyFunction;
    /**
     ...
     * @preserve (Part of the public API)
     */
    watch<T = ST>(callback?: (this: this, data: Symbol.IWatchResultObject<T> | Symbol.IServerWatchResultObject<T>) => void): TcHmi.DestroyFunction;
    /**
     * Watches for changes of the current symbol and raises the callback in case of a change.
     * Returns a destroy function to remove the watch.
     * @param options Options for symbol handling
     ...
     * @preserve (Part of the public API)
     */
    watchEx<T = ST>(options: Symbol.IOptions | null, callback?: (this: this, data: Symbol.IWatchResultObject<T> | Symbol.IServerWatchResultObject<T>) => void): TcHmi.DestroyFunction;
    /**
     ...
     * @preserve (Part of the public API)
     */
    resolveExpression(callback: (data: Symbol.IReadResultObject<SymbolExpression>) => void): TcHmi.DestroyFunction;
    /**
     * Watches the expression.
     * @param callback Callback will be called after success (with the schema) or failure
     * @preserve (Part of the public API)
     */
    watchExpression(callback: (data: Symbol.IReadResultObject<SymbolExpression>) => void): TcHmi.DestroyFunction;
    /**
     ...
     * @preserve (Part of the public API)
     */
    resolveReference(callback: (data: Symbol.IResolveSymbolReferenceResultObject) => void, options?: Symbol.IOptions): TcHmi.DestroyFunction;
    /**
     ...
     * @preserve (Part of the public API)
     */
    watchReference(callback: (data: Symbol.IResolveSymbolReferenceResultObject) => void, options?: Symbol.IOptions): TcHmi.DestroyFunction;
    /**
     ...
     * @preserve (Part of the public API)
     */
    resolveAttributes(callback?: (this: this, data: Symbol.IAttributesResultObject) => void): TcHmi.DestroyFunction;
    /**
     ...
     * @preserve (Part of the public API)
     */
    watchVersions(callback?: (this: this, data: Symbol.IVersionsResultObject) => void): TcHmi.DestroyFunction;
    /**
     ...
     * @preserve (Part of the public API)
     */
    watchMetaData(callback?: (this: this, data: Symbol.IServerSymbolMetaDataResultObject) => void): TcHmi.DestroyFunction;
    /**
...
export declare namespace Symbol {
     ...
     * @preserve (Part of the public API)
     */
    function read<T = any>(name: string, type: TcHmi.SymbolType): T | undefined;
    /**
     ...
     * @preserve (Part of the public API)
     */
    function readEx2<T = any>(expression: string, callback?: (this: void, data: IReadResultObject<T> | IServerReadResultObject<T>) => void): TcHmi.DestroyFunction;
    /**
     * Reads the value of a symbol by expression and raises a callback with the result.
     * Returns a destroy function to terminate reading of asynchronous values.
     * @param expressionObject Expression meta data object including the expression itself and further information like context.
     ...
     * @preserve (Part of the public API)
     */
    function readEx2<T = any>(expressionObject: ExpressionContainer, callback?: (this: void, data: IReadResultObject<T> | IServerReadResultObject<T>) => void): TcHmi.DestroyFunction;
    /**
     * Reads the value of a symbol by expression and raises a callback with the result.
     * Returns a destroy function to terminate reading of asynchronous values.
     * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
     ...
     * @preserve (Part of the public API)
     */
    function readEx2<T = any>(expressionOrExpressionObject: string | ExpressionContainer, callback?: (this: void, data: IReadResultObject<T> | IServerReadResultObject<T>) => void): TcHmi.DestroyFunction;
    /**
     * Reads the value of a symbol by expression and raises a callback with the result.
     * Returns a destroy function to terminate reading of asynchronous values.
     * @param expression Expression for the symbol
     ...
     * @preserve (Part of the public API)
     */
    function readEx3<T = any>(expression: string, options: IOptions | null, callback?: (this: void, data: IReadResultObject<T> | IServerReadResultObject<T>) => void): TcHmi.DestroyFunction;
    /**
     * Reads the value of a symbol by expression and raises a callback with the result.
     * Returns a destroy function to terminate reading of asynchronous values.
     * @param expressionObject Expression meta data object including the expression itself and further information like context.
     ...
     * @preserve (Part of the public API)
     */
    function readEx3<T = any>(expressionObject: ExpressionContainer, options: IOptions | null, callback?: (this: void, data: IReadResultObject<T> | IServerReadResultObject<T>) => void): TcHmi.DestroyFunction;
    /**
     * Reads the value of a symbol by expression and raises a callback with the result.
     * Returns a destroy function to terminate reading of asynchronous values.
     * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
     ...
     * @preserve (Part of the public API)
     */
    function readEx3<T = any>(expressionOrExpressionObject: string | ExpressionContainer, options: IOptions | null, callback?: (this: void, data: IReadResultObject<T> | IServerReadResultObject<T>) => void): TcHmi.DestroyFunction;
    /**
     ...
     * @preserve (Part of the public API)
     */
    function write<W = any, R = W>(name: string, type: TcHmi.SymbolType, value: W, callback?: null | ((this: void, data: IWriteResultObject<R> | IServerWriteResultObject<R>) => void)): TcHmi.DestroyFunction;
    /**
     ...
     * @preserve (Part of the public API)
     */
    function writeEx<T = any>(expression: string, value: T, callback?: null | ((this: void, data: IWriteResultObject<T> | IServerWriteResultObject<T>) => void)): TcHmi.DestroyFunction;
    /**
     * Writes the value of a symbol by expression.
     * Returns a destroy function to terminate writing of asynchronous values.
     * @param expressionObject Expression meta data object including the expression itself and further information like context.
     ...
     * @preserve (Part of the public API)
     */
    function writeEx<T = any>(expressionObject: ExpressionContainer, value: T, callback?: null | ((this: void, data: IWriteResultObject<T> | IServerWriteResultObject<T>) => void)): TcHmi.DestroyFunction;
    /**
     * Writes the value of a symbol by expression.
     * Returns a destroy function to terminate writing of asynchronous values.
     * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
     ...
     * @preserve (Part of the public API)
     */
    function writeEx<T = any>(expressionOrExpressionObject: string | ExpressionContainer, value: T, callback?: null | ((this: void, data: IWriteResultObject<T> | IServerWriteResultObject<T>) => void)): TcHmi.DestroyFunction;
    /**
     * Writes the value of a symbol by expression.
     * Returns a destroy function to terminate writing of asynchronous values.
     * @param expression Expression for the symbol
     ...
     * @preserve (Part of the public API)
     */
    function writeEx2<T = any>(expression: string, value: T, options: IOptions | null, callback?: null | ((this: void, data: IWriteResultObject<T> | IServerWriteResultObject<T>) => void)): TcHmi.DestroyFunction;
    /**
     * Writes the value of a symbol by expression.
     * Returns a destroy function to terminate writing of asynchronous values.
     * @param expressionObject Expression meta data object including the expression itself and further information like context.
     ...
     * @preserve (Part of the public API)
     */
    function writeEx2<T = any>(expressionObject: ExpressionContainer, value: T, options: IOptions | null, callback?: null | ((this: void, data: IWriteResultObject<T> | IServerWriteResultObject<T>) => void)): TcHmi.DestroyFunction;
    /**
     * Writes the value of a symbol by expression.
     * Returns a destroy function to terminate writing of asynchronous values.
     * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
     ...
     * @preserve (Part of the public API)
     */
    function writeEx2<T = any>(expressionOrExpressionObject: string | ExpressionContainer, value: T, options: IOptions | null, callback?: null | ((this: void, data: IWriteResultObject<T> | IServerWriteResultObject<T>) => void)): TcHmi.DestroyFunction;
    /**
     * Resolves the expression.
     * @param expression Expression for the symbol
     * @param callback Callback will be called after success (with the schema) or failure
     ...
     * @preserve (Part of the public API)
     */
    function resolveAttributes(expressionOrExpressionObject: string | ExpressionContainer, callback?: (this: void, data: TcHmi.Symbol.IAttributesResultObject) => void): void;
    /**
     * Resolves a PLC (?) attribute by name from the underlying schema.
     * @param expression Expression for the symbol
     * @param name Name of the PLC (?) attribute
...
type tISymbolResultObject = Symbol.ISymbolResultObject;
type tIWatchResultObject<T = any> = Symbol.IWatchResultObject<T>;
type tIServerWatchResultObject<T = any> = Symbol.IServerWatchResultObject<T>;
type tIReadResultObject<T = any> = Symbol.IReadResultObject<T>;
type tIServerReadResultObject<T = any> = Symbol.IServerReadResultObject<T>;
type tIWriteResultObject<T = any> = Symbol.IWriteResultObject<T>;
type tIServerWriteResultObject<W = any, R = W> = Symbol.IServerWriteResultObject<W, R>;
type tISchemaResultObject = Symbol.ISchemaResultObject;
type tIExistsResultObject = Symbol.IExistsResultObject;
type tIAttributesResultObject = Symbol.IAttributesResultObject;
type tIAttributeResultObject<T = any> = Symbol.IAttributeResultObject<T>;
type tIVersionsResultObject = Symbol.IVersionsResultObject;
type tIServerSymbolMetaDataResultObject = Symbol.IServerSymbolMetaDataResultObject;
type tIListSymbols = Symbol.IListSymbols;
type tIOptions = Symbol.IOptions;
type tReferenceDelegation = Symbol.ReferenceDelegation;
type tIResolveSymbolReferenceResultObject = Symbol.IResolveSymbolReferenceResultObject;
type tExpressionContainer = Symbol.ExpressionContainer;
declare global {
    namespace TcHmi {
