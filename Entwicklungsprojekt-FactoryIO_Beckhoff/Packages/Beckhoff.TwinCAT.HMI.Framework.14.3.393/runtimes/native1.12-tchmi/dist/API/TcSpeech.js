import{isParameterTypeInvalid}from"../System/SystemFunctions.js";import{tcSpeechManager}from"../System/TcSpeechManager.js";import*as Callback from"./Callback.js";
/**
...
/**
     ...
     * @preserve (Part of the public API)
     */
start(callback){tcSpeechManager.speechSynthesisStart(this.text,this.options,data=>{this.__guid=data.guid,Callback.callSafe(callback,null,data)})}
/**
     ...
     * @preserve (Part of the public API)
     */getStatus(callback){this.__guid?tcSpeechManager.speechSynthesisGetStatus(this.__guid,callback):Callback.callSafe(callback,null,{error:TcHmi.Errors.ERROR,details:{code:TcHmi.Errors.ERROR,domain:"TcHmi.TcSpeech",reason:"No current speech synthesis."}})}
/**
     * Stops a given speech synthesis call.
     * @param callback The callback will get the state of the speech synthesis
     * @preserve (Part of the public API)
     */stop(callback){this.__guid?tcSpeechManager.speechSynthesisStop(this.__guid,callback):Callback.callSafe(callback,null,{error:TcHmi.Errors.ERROR,details:{code:TcHmi.Errors.ERROR,domain:"TcHmi.TcSpeech",reason:"No current speech synthesis."}})}}TcHmi.TcSpeech={...TcHmi.TcSpeech??{},openConnection,closeConnection,setVolume,SpeechSynthesis};