...
type tKeyframe = Animation.Keyframe;
type tAnimationEvent = Animation.AnimationEvent;
type tStatus = Animation.Status;
type tDirection = Animation.Direction;
type tFillMode = Animation.FillMode;
declare global {
    namespace TcHmi {
