...
import { ControlLocalization } from '../../../API/Locale.js';
/**
...
declare class TcHmiControl extends TcHmi.Controls.System.baseTcHmiControl {
    ...
    protected __objectResolvers: Map<string, {
        resolver: ObjectResolver<object | null>;
        watchCallback: (data: ObjectResolver.IWatchResultObject<object | null>) => void;
     ...
     */
    protected __onResolverForAccessConfigWatchCallback(data: ObjectResolver.IWatchResultObject<TcHmi.AccessControl[]>): void;
    /**
     ...
     */
    protected __onResolverForVirtualControlRightMappingsWatchCallback(data: ObjectResolver.IWatchResultObject<TcHmi.VirtualControlRightMapping[]>): void;
    /**
     ...
     */
    protected __onResolverForTransformWatchCallback(data: ObjectResolver.IWatchResultObject<TcHmi.Transform[]>): void;
    /**
     ...
     */
    protected __onResolverForBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<TcHmi.Color>): void;
    /**
     ...
     */
    protected __onResolverForBackgroundImagePaddingWatchCallback(data: ObjectResolver.IWatchResultObject<TcHmi.FourSidedCss>): void;
    /**
     ...
     */
    protected __onResolverForBorderColorWatchCallback(data: ObjectResolver.IWatchResultObject<TcHmi.Color>): void;
    /**
     ...
     */
    protected __onResolverForBorderWidthWatchCallback(data: ObjectResolver.IWatchResultObject<TcHmi.BorderWidth>): void;
    /**
     ...
     */
    protected __onResolverForBorderRadiusWatchCallback(data: ObjectResolver.IWatchResultObject<TcHmi.BorderRadius>): void;
    /**
     ...
     */
    protected __onResolverForBorderStyleWatchCallback(data: ObjectResolver.IWatchResultObject<TcHmi.BorderStyle>): void;
    /**
     ...
     */
    protected __onResolverForBoxShadowWatchCallback(data: ObjectResolver.IWatchResultObject<TcHmi.BoxShadow[]>): void;
    /**
