import { Control as TcHmiControl, type IControlSpecificData as ITcHmiControlSpecificData } from '../TcHmiControl/TcHmiControl.esm.js';
...
declare class TcHmiGrid extends TcHmiContainerControl {
     ...
     */
    protected __onGridRowOrColumnIndexChanged(_event: EventProvider.Event, control: TcHmi.Controls.System.baseTcHmiControl): void;
    /**
     * Adjust Cell Dimension on Control resize or move
     * @param move Is this a moved control? If not it was resized
     */
    protected __onControlGeometryChanged(event: EventProvider.Event, controls: TcHmi.Controls.System.baseTcHmiControl[]): void;
