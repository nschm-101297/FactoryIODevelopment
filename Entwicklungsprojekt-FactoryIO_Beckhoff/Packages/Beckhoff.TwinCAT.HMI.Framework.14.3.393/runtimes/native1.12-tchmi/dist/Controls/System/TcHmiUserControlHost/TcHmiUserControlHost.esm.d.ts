import type { UserControlConfig } from '../../../System/_Types.js';
...
declare class TcHmiUserControlHost extends TcHmiControl {
     ...
     * @param data
     */
    protected __onUserControlChanged(_event: EventProvider.Event, data: {
        url: string;
        content: string;
    }): void;
    /**
     ...
     * @param data
     */
    protected __onUserControlConfigChanged(_event: EventProvider.Event, data: {
        url: string;
    }): void;
    /**
     * @param _event
     * @param data
     */
    protected __onUserControlCreated(_event: EventProvider.Event, data: {
        url: string;
    }): void;
    /**
     * @param _event
     * @param data
     */
    protected __onUserControlRemoved(_event: EventProvider.Event, data: {
        url: string;
    }): void;
    /**
